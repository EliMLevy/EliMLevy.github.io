...
class BlockSix extends Block {
    constructor() {
        super();
        this.squares[0] = new Square(30 * 3, 30 * 1, 1, [255, 153, 0]);
        this.squares[1] = new Square(30 * 4, 30 * 1, 1, [255, 153, 0]);
        this.squares[2] = new Square(30 * 5, 30 * 1, 2, [255, 153, 0]);
        this.squares[3] = new Square(30 * 4, 30 * 0, 3, [255, 153, 0]);
    }
    ...
    canRotate() {
        if (this.orientation == 0) {
            ...
            */
            ...
            3 => right 30 up 30
            */
            if(this.squares[0].check(-1,-1) && this.squares[2].check(1,1) && this.squares[3].check(1,-1)) {
                return true;
            } else {
                return false;
            }
    ...
    rotateBlock() {
        if (this.orientation == 0) {
            let temp = [];
            temp[0] = new Square(this.squares[0].pos.x + 30, this.squares[0].pos.y + 30, 0, [255, 153, 0]);
            temp[1] = new Square(this.squares[1].pos.x, this.squares[1].pos.y, 1, [255, 153, 0]);
            temp[2] = new Square(this.squares[2].pos.x, this.squares[2].pos.y, 2, [255, 153, 0]);
            temp[3] = new Square(this.squares[3].pos.x, this.squares[3].pos.y, 3, [255, 153, 0]);
            this.squares = temp;
            this.orientation = 1;
        } else if (this.orientation == 1) {
            let temp = [];
            temp[0] = new Square(this.squares[0].pos.x, this.squares[0].pos.y, 0, [255, 153, 0]);
            temp[1] = new Square(this.squares[1].pos.x, this.squares[1].pos.y, 1, [255, 153, 0]);
            temp[2] = new Square(this.squares[2].pos.x, this.squares[2].pos.y, 2, [255, 153, 0]);
            temp[3] = new Square(this.squares[3].pos.x - 30, this.squares[3].pos.y + 30, 3, [255, 153, 0]);
            this.squares = temp;
            this.orientation = 2;
        } else if (this.orientation == 2) {
            let temp = [];
            temp[0] = new Square(this.squares[0].pos.x, this.squares[0].pos.y, 0, [255, 153, 0]);
            temp[1] = new Square(this.squares[1].pos.x, this.squares[1].pos.y, 1, [255, 153, 0]);
            temp[2] = new Square(this.squares[2].pos.x - 30, this.squares[2].pos.y - 30, 2, [255, 153, 0]);
            temp[3] = new Square(this.squares[3].pos.x, this.squares[3].pos.y, 3, [255, 153, 0]);
            this.squares = temp;
            this.orientation = 3;
        } else if (this.orientation == 3) {
